...
$(this).closest('.row').find('.question_container').append(' <div class="single_questions"> <div class="form-group"> <label class="col-md-4 control-label" for="Name">Question</label> <div class="col-md-4"> <input id="question_name" name="question" type="text" placeholder="Enter Question" class="form-control input-md question" required=""> </div></div><div class="form-group"> <label class="col-md-4 control-label" for="Name">Answer</label> <div class="col-md-4"> <input id="Name" name="answer" type="text" placeholder="Enter Answer" class="form-control input-md answer" required=""> </div></div> </div>');

}else if(this.value=='mcq'){
$(this).closest('.row').find('.question_container').empty();
$(this).closest('.row').find('.question_container').append(' <div class="form-group"> <label class="col-md-4 control-label">Question</label> <div class="col-md-4"> <input id="Name" name="Name" type="text" placeholder="Enter Question" class="form-control input-md mcq_quest" required=""> </div></div>  <div class="choices"> </div><div class="row "> <div class="col-md-2 col-md-offset-4 "> <button class="btn btn-sm btn-warning add_choice_btn"> <span class="glyphicon glyphicon-plus"></span> Add Choice </button> </div></div>');
...
$('.Questions_main_container').on('click','.add_choice_btn',function () {
    ...
    $(this).closest('.question_container').find('.choices').append(' <div class="form-group mcqs"><div class="child"> <label class="col-md-4 control-label" for="Name">Choice 1</label> <div class="col-md-4"> <input id="Name" name="mcq" type="text" placeholder="Enter Option" class="form-control input-md choice" required=""> </div><div class="col-md-1"> <input name="correct" type="radio" class="radio_correct"> Correct? </div><div class="col-md-2"> <button class="btn btn-danger btn-sm pull-right delete_choice" > <span class="glyphicon glyphicon-trash"></span> Delete Choice </button> </div></div></div>');
});
